<?php 
global $avia_config;
$pageIdCustomHtmlHeader = 3201;//3201 //default disable id=0
					...
					$output .= "<div class='inner-container'>";
						...
						*/
						...
						$output .= avia_logo(AVIA_BASE_URL.'images/layout/logo.png', $addition, 'span', true);
							...
							/**
							 * display custom HTML header
							 */
							if($pageIdCustomHtmlHeader>0){
							$page=get_page( $pageIdCustomHtmlHeader);
							$post_content = $page->post_content;
    							if($post_content){
    							    $output .= "<!--<div class='callus'></div>-->";
    							    $output .=$post_content;
    							}
							}
							//end
